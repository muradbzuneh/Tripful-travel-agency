export const attraction = [
  {
    ...
    place: "Lake Tana & Blue Nile Falls - Bahir Dar",
    Historicalplace:
...

  {
    id: 4,
    img: "/src/assests/images/planew.jpg",
    place: "Jimma abba Jifar Palace - Jimma",
    Historicalplace:
