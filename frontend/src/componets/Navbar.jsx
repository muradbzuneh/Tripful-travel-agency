          ...
          <div className="nav-links-container">
            ...
            {!isStaffOrAdmin ? (
              <>
                ...
                <Link to="#" onClick={handleNavScroll("Events")}>Events</Link>
                <Link to="/attractions" onClick={closeMobileMenu}>Attractions</Link>
            ...
            {isAuthenticated ? (
              <>
                ...
                {isStaffOrAdmin && <Link to="/staff" onClick={closeMobileMenu}>Staff Dashboard</Link>}
                {isAdmin && <Link to="/admin" onClick={closeMobileMenu}>Admin Panel</Link>}
              ...
              <div className="auth-links">
                ...
                <Link to="/register" onClick={closeMobileMenu} className="register-btn">Register</Link>
              </div>
            )}
          </div>
        </div>
